...
folder = 'C:/Users/User/Desktop/philips/manifest-1648648375084/LDCT-and-Projection-data/L033/08-28-2018-NA-NA-93540/1.000000-Full dose projections-02630'
...
path_com = 'results/GAN_L033/' + '_com_' + args.mode + '_' + str(args.l) + '/'
path_bin = 'results/GAN_L033/' + '_bin_' + args.mode + '_' + str(args.l) + '/'
...
model_path = './OpenDVC_' + args.mode +'_GAN'+ str(args.l)+str(args.a) +'_N_'+str(args.N) +'/model.ckpt-2000'
...
for gop_number in range(1):
    ...
    for p_frame in range(frames-1):
        ...
        print(np.max(F0_com), 'maximum value in tensor')
