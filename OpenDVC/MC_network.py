...
def MC(input, filters_final = 3):
    ...
    m13 = tf.layers.conv2d(inputs=m12, filters=filters_final, kernel_size=3, strides=1, padding='same',
                           kernel_initializer=tf.contrib.layers.xavier_initializer(uniform=True), name='mc13')
    #filters is number of output layers
