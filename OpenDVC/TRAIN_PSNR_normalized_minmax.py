...
exper = Experiment(api_key = "SCNv0oqcoLPJnXIqei3EvhuKR",
                   project_name = "DVC_1_folder_PSNR_1024_normalized_minmax-n-m-128", #the same forlder as for 1024
...
saver.restore(sess, save_path='OpenDVC_PSNR_1024one_folder_minmax_norm_N_M_128/model.ckpt-2600')
